...
public class GlobalExceptionHandler {
     ...
     * This avoids ambiguity by grouping your custom runtime exceptions.
     */
    @ExceptionHandler({
 ...
 /*   @ExceptionHandler(RuntimeException.class)
   ...
   /*  @ExceptionHandler(BatchNotFoundException.class)
    ...
    /** * 9. 500 – Safety Net
     * We use Exception.class here to catch anything not handled above.
     * We DO NOT include a separate RuntimeException.class handler to avoid ambiguity.
     */
    @ExceptionHandler(Exception.class)
    public ResponseEntity<Map<String, Object>> handleGeneric(Exception ex) {
        // If it's a runtime exception we didn't catch specifically,
        // we can still check the message for 404 logic here if desired.
